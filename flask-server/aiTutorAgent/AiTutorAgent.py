...
class AiTutorAgent:
    ...
    def _get_session_files_by_course(self, course_code: str):
        SESSION_HISTORY_DIR = "saved_session_history"
        return [os.path.join(SESSION_HISTORY_DIR, f) for f in os.listdir(SESSION_HISTORY_DIR) if f.split("_")[2] == course_code]
    ...
    def _generate_visualizations(self, title: str):
        try:
            ...
            if "Student" in title:
                ...
                course_counts.plot(kind="pie", autopct="%1.1f%%", colors=["lightgreen", "lightcoral", "lightskyblue"])
                ...
                plt.figure(figsize=(8, 8))
                course_counts.plot(kind="pie", autopct="%1.1f%%", colors=["gold", "lightblue", "lightgreen"])
                ...
                plt.figure(figsize=(8, 8))
                course_counts.plot(kind="pie", autopct="%1.1f%%", colors=["lightpink", "lightblue", "lightgreen"])
